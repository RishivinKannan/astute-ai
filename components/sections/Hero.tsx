  ...
  return (
    <section className="relative  w-full  overflow-hidden">
      ...
      <div className="container absolute inset-0 px-20 z-20 mx-auto pt-8  ">
        <TextGenerateEffect
          className=" text-white text-center text-2xl md:text-4xl xl:text-6xl tracking-wider mb-8"
          words="Transforming Business Workflow, Enhancing Business Performance"
        />
        <InputBox />
        <p className="text-[10px] xl:text-sm p-1 text-center">
          I am a Generative AI search engine for this website. I will assist you
          in navigating throughout the website.
        </p>
        <div className="w-full md:w-5/6 mx-auto h-4/6 mt-14 bg-indigo-950 rounded-[3rem]" />
      </div>
    </section>
  );
};
